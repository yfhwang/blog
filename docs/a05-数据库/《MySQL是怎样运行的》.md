...
![image_1c8d26fmg1af0ms81cpc7gm8lv39.png-97.9kB](../images/167f4c7b99f87e1c.png)
...
![image_1c91mt04ll7suk01ej01fb067k9.png-89.7kB](../images/167815b6f78145f8.png)
...
![image_1c9g4t114n0j1gkro2r1h8h1d1t16.png-42.4kB](../images/169104f5702043d7.png)
...
![image_1c9gbruvo504dlg1qsf19nbeu878.png-37kB](../images/169104f570f8ed73.png)
...
![image_1c9grq2b2jok1062t8tov21lqjbj.png-42.6kB](../images/169104f5719c4037.png)
...
2.  如果表中没有允许存储 _**NULL**_ 的列，则 _NULL值列表_ 也不存在了，否则将每个允许存储`NULL`的列对应一个二进制位，二进制位按照列的顺序逆序排列，二进制位表示的意义如下：
    ...
    *   二进制位的值为`0`时，代表该列的值不为`NULL`。
    ...
    ![image_1c9g88mtt1tj51ua1qh51vjo12pg5k.png-10.4kB](../images/169104f5728fdd01.png)
...
3.  `MySQL`规定`NULL值列表`必须用整数个字节的位表示，如果使用的二进制位个数不是整数个字节，则在字节的高位补`0`。
    ...
    ![image_1c9g8g27b1bdlu7t187emsc46s61.png-19.4kB](../images/169104f574d5df2e.png)
...
*   对于第一条记录来说，`c1`、`c3`、`c4`这3个列的值都不为`NULL`，所以它们对应的二进制位都是`0`，画个图就是这样：
    ...
    ![image_1c9g8m05b19ge1c8v2bf163djre6e.png-21.5kB](../images/169104f5756f3663.png)
    
    所以第一条记录的`NULL值列表`用十六进制表示就是：`0x00`。
    
*   对于第二条记录来说，`c1`、`c3`、`c4`这3个列中`c3`和`c4`的值都为`NULL`，所以这3个列对应的二进制位的情况就是：
  
    ![image_1c9g8ps5c1snv1bhj3m48151sfl6r.png-20.6kB](../images/169104f5a46c082d.png)
...
![image_1c9grs9m4co8134u1t2rjhm1q6rc0.png-39kB](../images/169104f5a7c50032.png)

##### 记录头信息

除了`变长字段长度列表`、`NULL值列表`之外，还有一个用于描述记录的`记录头信息`，它是由固定的`5`个字节组成。`5`个字节也就是`40`个二进制位，不同的位代表不同的意思，如图：

![image_1c9geiglj1ah31meo80ci8n1eli8f.png-29.5kB](../images/169104f5a87e0271.png)
...
![image_1c9gruej1am71ph9refjli16lhct.png-149.8kB](../images/169104f5a964cbf3.png)
...
![image_1c9h256f9nke14311adhtu61ie2dn.png-92kB](../images/169104f5aa08037c.png)
...
![image_1c9jdkga71kegkjs14o111ov1ce3kn.png-12.5kB](../images/169104f5cfa6ef3d.png)
...
![image_1c9jeb6defgf1o981lgfciokjl4.png-43.1kB](../images/169104f5d047e541.png)
...
![image_1c9h896lcuqi16081qub1v8c12jkft.png-36.2kB](../images/169104f5d1399d5f.png)
...
![image_1c9h8tnav166c187m1nhap61153qgn.png-91.6kB](../images/169104f5d357a6e0.png)
...
![image_1d48e3imu1vcp5rsh8cg0b1o169.png-149kB](../images/16910e3fb544aed7.png)
...
![image_1conbskr7apj19ns1d194vs1buo1t.png-35.8kB](../images/169104f5ff0a8b3c.png)
...
![image_1conbtnmr1sg1hao1nf41pi1eb72a.png-29.9kB](../images/169104f5ff959467.png)
...
3.  `InnoDB`目前定义了4中行格式
    ...
    *   Redundant行格式
        ...
        ![image_1ctfppb4c1cng1m8718l91760jde9.png-36.2kB](../images/169104f5ffe017bf.png)
...
![image_1crh8esga1j5l1d6f1idggech95p.png-69kB](../images/16910faa7d2c1dfc.png)
...
![image_1cosvi1in9st476cdqfki1n39m.png-133.8kB](../images/16910faa7f39b19b.png)
...
![image_1c9o2eib2vl11qnf1dfl1d2lco313.png-76.4kB](../images/16910faa7fb96a2b.png)
...
![image_1c9o52lt41v5c7vk1vm91fsm174b2d.png-49.5kB](../images/16910faa7fc922e1.png)
...
![image_1c9qs0j281knc16hc1hqsgj01v0o2c.png-82.8kB](../images/16910faa7fa53c71.png)
...
*   `heap_no`
    ...
    ![image_1c9ra45eam7t1mil9o1h3ucqdhv.png-50.4kB](../images/16910faaae699d06.png)
    
    由于这两条记录不是我们自己定义的记录，所以它们并不存放在`页`的`User Records`部分，他们被单独放在一个称为`Infimum + Supremum`的部分，如图所示：
    
    ![image_1c9qs1mn2t3j1nt344116nk15uf2p.png-119.7kB](../images/16910faa7fb8234e.png)
...
*   `next_record`
    ...
    ![image_1cot1r96210ph1jng1td41ouj85c13.png-120.5kB](../images/16910faaae5618fb.png)
    ...
    ![image_1cul8slbp1om0p31b3u1be11gco9.png-119.6kB](../images/16910faaae709be3.png)
...
![image_1cot2j9n94a511jd15clrrfp6p1t.png-137.8kB](../images/16910faaae8b46cd.png)
...
![image_1couapvdmb5mvm1i0l5m0vcb2a.png-128.2kB](../images/16910faaaea593a4.png)
...
![image_1couarh4no6j1a8q9htilr13qc2n.png-105.1kB](../images/16910faab125e162.png)

哎呀，咋看上去怪怪的，这么乱的图对于我这个强迫症真是不能忍，那我们就暂时不管各条记录在存储设备上的排列方式了，单纯从逻辑上看一下这些记录和页目录的关系：

![image_1couate3jr19gc18gl1cva1fcg34.png-100.8kB](../images/16910faacfbd4080.png)
...
![image_1coub0tq01b8scui9ia1fge124b3h.png-185.7kB](../images/16910faad54ff9e6.png)
...
*   `FIL_PAGE_PREV`和`FIL_PAGE_NEXT`
    ...
    ![image_1ca00fhg418pl1f1a1iav1uo3aou9.png-90.9kB](../images/16910faad0e37047.png)
...
![image_1cov976plf2u1j3g1jp8serjc616.png-87.7kB](../images/167627a904b33284.png)
...
![image_1caac8jr7hhcld017gd1lch1n1m33.png-97.1kB](../images/167627a904d072c4.png)
...
![image_1caacokob6ne1nv41meda0s7vk3g.png-68.1kB](../images/167627a9051511d9.png)

把一些记录放到页里边的示意图就是：

![image_1caadhc4g1pb7hk81fcd4vt1u6r3t.png-79.8kB](../images/167627a90612d9f7.png)
...
*   下一个数据页中用户记录的主键值必须大于上一个页中用户记录的主键值。
    ...
    ![image_1caaf26411d51bq7jtrvesr04a.png-29.5kB](../images/167627a9071559ed.png)
    ...
    ![image_1caafbcj1qpo1ad2j8q1ci4136s4n.png-44.5kB](../images/167627a908527d1a.png)
    ...
    ![image_1caafkq3h1akv1mde14h2kjul6554.png-96.9kB](../images/167627a934270ad1.png)
...
*   给所有的页建立一个目录项。
    ...
    ![image_1cab9u9midn61fgq1mi58j0gadm.png-65.7kB](../images/167627a9343577b3.png)
    ...
    *   页号，我们用`page_no`表示。
    ...
    ![image_1caba0afo11fa1cli1nu070m16bg1j.png-119.1kB](../images/167627a93e0c8dfe.png)
...
![image_1caahuomf15m11e5k19v1bf21inq9.png-145.9kB](../images/167627a93e14c7be.png)
...
![image_1cacabsrh17a5133q1otf725gi92q.png-135.7kB](../images/167627a93f82e166.png)
...
![image_1cacafpso19vpkik1j5rtrd17cm3a.png-158.1kB](../images/167627a9496cd230.png)
...
![image_1ca80gps314u9121u1rdp9r7md8cm.png-55.6kB](../images/167627a961cd3016.png)
...
![image_1cactc8jg14j91likvmd1h8cn3o4h.png-161.6kB](../images/167627a961fd74e7.png)
...
![image_1cacvu3hmlr9m501r6b1809uo35o.png-165.1kB](../images/167627a9661391c4.png)
...
![image_1cp9vthl71h9n8091dkdjek16qg1j.png-58.6kB](../images/167627a96625ebb1.png)
...
![image_1cpb919suginpp7lbgsk0147f20.png-58.6kB](../images/167627a97d84ddee.png)
...
*   将表中的记录按照记录的插入顺序单独存储在一个文件中，称之为`数据文件`。这个文件并不划分为若干个数据页，有多少记录就往这个文件中塞多少记录就成了。我们可以通过行号而快速访问到一条记录。
    ...
    ![image_1cpc7go2o12t1ocd17nvr6msth9.png-58.9kB](../images/167627a9871b342f.png)
...
![image_1cpk121ttgku1lj7n4l1g81152k9.png-141.1kB](../images/16777d60a0b65741.png)
...
![image_1capq3r1o1geqdck1cnc1fkihj39.png-28.1kB](../images/16777d60a0cf8c4d.png)

如果此时再插入一条主键值为`9`的记录，那它插入的位置就如下图：

![image_1capq7nnv13en8b31lvtj2i1e8lm.png-35.3kB](../images/16777d60a104774b.png)
...
![image_1crjupisqne61uer17ikh6l1v8k9.png-44.9kB](../images/167ac6442f4e4edd.png)
...
![image_1cri1nutcorp5ghf5c7vqagt1j.png-71.4kB](../images/167ac6442f8e6644.png)
...
![image_1crjo0hl4q8u1dkdofe187b10fa9.png-105.2kB](../images/167ac6443071a286.png)
...
![image_1crre79uq9971bsdj9s1i0j11en8a.png-96.2kB](../images/167ac6443128f22f.png)
...
*   `List Node`（12字节）
    ...
    ![image_1crre8tlh1vmqtfipk663l173q97.png-69.1kB](../images/167ac64431fef247.png)
...
![image_1crrehf6i1jsq1j5cubj1mdoh77a4.png-81.6kB](../images/167ac64432dedff7.png)
...
![image_1crrju0cnji91a2fhv91ijb15hgb1.png-111.4kB](../images/167ac644668c6cd1.png)
...
![image_1crmfvigk938c8h1hahglr15329.png-146.8kB](../images/167ac6446dbf2e3f.png)
...
![image_1crrp2qp310rc10fd33ch716hcp.png-148.1kB](../images/167ac6447c1d8805.png)
...
![image_1cs3vmoii1h971aje1iveack1l109.png-149.5kB](../images/167ac64482356d3e.png)
...
![image_1cs41k0p51p7uaq81jitr2b12be13.png-171kB](../images/167ac6448cef481c.png)
...
![image_1csob472617uijtmc1c1k6lj9k9.png-62.2kB](../images/167ac644922369a7.png)
...
![image_1csbied27ohe1rgg32gquulplm.png-147.4kB](../images/167ac6449a441ffc.png)
...
![image_1cso838gk5vt14bv12so1ue4lod6l.png-201.1kB](../images/167ac6449d8e1436.png)
...
![image_1ctendl4319v659s1dfoj6lssl16.png-36.4kB](../images/167cece536c16a14.png)
...
![image_1cthurrlpbhlotsjru1dsjrrl30.png-110.2kB](../images/167cece53760be3d.png)
...
![image_1ctf14vso11cdclsmc6ac8pru9h.png-109.5kB](../images/167cece5377ba4d7.png)
...
![image_1ctf21uu8113m1ajm1rcitgf5eeco.png-122.5kB](../images/167cece5375a11e7.png)
...
![image_1cth9mkf41li1dad1tnd6dm5139.png-9.2kB](../images/167cece53770ba99.png)
...
![image_1ctia5p09rqss4413qq16gdbbj3q.png-44kB](../images/167cece53fac75d6.png)
...
![image_1ctia94i617ihr5ncku4ed1gg247.png-49.1kB](../images/167cece5630e89ef.png)
...
![image_1cql4ae7flug1itskat1ojgi7g3m.png-67.4kB](../images/167e43ab3feccc29.png)
...
1.  首先确定第一个需要查询的表，这个表称之为`驱动表`。怎样在单表中执行查询语句我们在前一章都唠叨过了，只需要选取代价最小的那种访问方法去执行单表查询语句就好了（就是说从const、ref、ref\_or\_null、range、index、all这些执行方法中选取代价最小的去执行查询）。此处假设使用`t1`作为驱动表，那么就需要到`t1`表中找满足`t1.m1 > 1`的记录，因为表中的数据太少，我们也没在表上建立二级索引，所以此处查询`t1`表的访问方法就设定为`all`吧，也就是采用全表扫描的方式执行单表查询。关于如何提升连接查询的性能我们之后再说，现在先把基本概念捋清楚哈。所以查询过程就如下图所示：
    ...
    ![image_1ctpnftbge08uf1ek61qor1fh14g.png-23.9kB](../images/167e43ab3dfab5ed.png)
...
2.  针对上一步骤中从驱动表产生的结果集中的每一条记录，分别需要到`t2`表中查找匹配的记录，所谓`匹配的记录`，指的是符合过滤条件的记录。因为是根据`t1`表中的记录去找`t2`表中的记录，所以`t2`表也可以被称之为`被驱动表`。上一步骤从驱动表中得到了2条记录，所以需要查询2次`t2`表。此时涉及两个表的列的过滤条件`t1.m1 = t2.m2`就派上用场了：
    ...
    *   当`t1.m1 = 3`时，过滤条件`t1.m1 = t2.m2`就相当于`t2.m2 = 3`，所以此时`t2`表相当于有了`t1.m1 = 3`、`t2.n2 < 'd'`这两个过滤条件，然后到`t2`表中执行单表查询。
    ...
    ![image_1ctrsprar1bbh17lee79le63ls2m.png-49.6kB](../images/167e43ab3a02660b.png)
...
![image_1ctsr5ui2cdk1jduqafm7p1d3426.png-129.4kB](../images/167e43ab3fa0f107.png)
...
![image_1ctuhe3t71ahd10gn19917fo1nft4g.png-57.7kB](../images/167e43ab3e5fa2f6.png)
...
![image_1cudvercs1km11nu74fbckb1fl8m.png-117.5kB](../images/167a79434866cf8f.png)
...
*   需要回表的记录数
    ...
    *   步骤3：如果`区间最左记录`和`区间最右记录`相隔不太远（在`MySQL 5.7.21`这个版本里，只要相隔不大于10个页面即可），那就可以精确统计出满足`key2 > 10 AND key2 < 1000`条件的二级索引记录条数。否则只沿着`区间最左记录`向右读10个页面，计算平均每个页面中包含多少记录，然后用这个平均值乘以`区间最左记录`和`区间最右记录`之间的页面数量就可以了。那么问题又来了，怎么估计`区间最左记录`和`区间最右记录`之间有多少个页面呢？解决这个问题还得回到`B+`树索引的结构中来：
        ...
        ![image_1cubndfil1i02ddfas1j3brq9m.png-85.3kB](../images/167a79434ad70118.png)
...
![image_1cubvsars1i0rvdc11b3118th9830.png-124.1kB](../images/167a79434b362e5e.png)
...
*   从叶子节点段和非叶子节点段的`Segment Header`中找到这两个段对应的`INODE Entry`结构。
    ...
    ![image_1cum7dbc812843ac192pfik1raep.png-107.3kB](../images/167e94d5b165a91f.png)
    
*   从对应的`INODE Entry`结构中可以找到该段对应所有零散的页面地址以及`FREE`、`NOT_FULL`、`FULL`链表的基节点。
  
    这个是`INODE Entry`结构：
    
    ![image_1cum7f49h1beg5uccbq197n1g1b16.png-173.9kB](../images/167e94d5b1e44524.png)
    
*   直接统计零散的页面有多少个，然后从那三个链表的`List Length`字段中读出该段占用的区的大小，每个区占用`64`个页，所以就可以统计出整个段占用的页面。
  
    这个是链表基节点的示意图：
    
    ![image_1cum7hkiihikm4b88j10461plc1j.png-129.9kB](../images/167e94d5b17c24e3.png)
...
*   从表`s1`的角度来看待，整个查询的意思其实是：对于`s1`表中的每条记录来说，如果该记录的`key1`列的值在子查询对应的物化表中，则该记录会被加入最终的结果集。画个图表示一下就是这样：
    ...
    ![image_1cvfj9up26i518t91li5ooq1r0u2d.png-84.9kB](../images/167e9e704abd19e4.png)
    
*   从子查询物化表的角度来看待，整个查询的意思其实是：对于子查询物化表的每个值来说，如果能在`s1`表中找到对应的`key1`列的值与该值相等的记录，那么就把这些记录加入到最终的结果集。画个图表示一下就是这样：
  
    ![image_1cvfjg3os1oh1e3o5c11dhd1odd2q.png-67.4kB](../images/167e9e704f8befd2.png)
...
*   LooseScan execution strategy （松散索引扫描）
    ...
    ![image_1cvg8f3nst9n1amc14iljc3i4c37.png-110.3kB](../images/167e9e704e05a551.png)
...
![image_1d15mh3d4oadq0e1qpme22u8i61.png-47.4kB](../images/1693e86e2b9d6dd1.png)
...
![image_1d155te021bmgjt09mo1lln17dum.png-132.6kB](../images/1693e86e300173c1.png)
...
![image_1d1589dpqmt5v1849s7614nu23.png-133.5kB](../images/1693e86e2ec4572a.png)
...
![image_1d15fb53d2lf13ovglg1rnv1h2n2g.png-116.5kB](../images/1693e86e2a3fffa3.png)
...
![image_1d15nmrbi19mv1tbk191eoqbmb47e.png-87.2kB](../images/1693e86e2abd79c1.png)
...
![image_1d15r7te41q58egj1b4plh615ug7r.png-125.5kB](../images/1693e86e2a5de8f2.png)
...
![image_1d1stskva1vp4a7f5kjdi7pf19.png-74.2kB](../images/16879ea4c29fb05f.png)


但是很不幸，真实的数据库中`T1`和`T2`的操作可能交替执行，比如这样：

![image_1d1sut47o5tk13ul4gb1qibuct2j.png-67.9kB](../images/16879f41669c8844.png)
...
![image_1d1vcal4q1ns81f5pcbb1cf6ojcp.png-69.9kB](../images/169488b0a88f6569.png)
...
![image_1d36k7d3412oo1c0qcuuben12l79.png-31.3kB](../images/1694892fdec61898.png)
...
![image_1d3fv01mv3jd7m719rpmn2jcsp.png-42.6kB](../images/1694892fdf053082.png)
...
![image_1d3fv8at819jh1m7m1sfb1donvmu16.png-47.2kB](../images/1694892fdf3da823.png)
...
![image_1d3gv4i7vtsirf81ikl1q2140n2g.png-67.2kB](../images/1694892fdfa7d8ce.png)
...
![image_1d3bn8tsq1ssp1nmdks8kdr17e31t.png-85.7kB](../images/1694892fe02553d0.png)
...
*   情况一：该数据页的剩余的空闲空间充足，足够容纳这一条待插入记录，那么事情很简单，直接把记录插入到这个数据页中，记录一条类型为`MLOG_COMP_REC_INSERT`的`redo`日志就好了，我们把这种情况称之为`乐观插入`。假如某个索引对应的`B+`树长这样：
    ...
    ![image_1d4fc7b6b1ftt16ji11as4a63h23.png-30.8kB](../images/1694892fe05a2603.png)
    
    现在我们要插入一条键值为`10`的记录，很显然需要被插入到`页b`中，由于`页b`现在有足够的空间容纳一条记录，所以直接将该记录插入到`页b`中就好了，就像这样：
    
    ![image_1d4fcbg9e1m1b1qtj1emgphorrl2g.png-43.3kB](../images/16948930120794a0.png)
...
*   情况二：该数据页剩余的空闲空间不足，那么事情就悲剧了，我们前边说过，遇到这种情况要进行所谓的`页分裂`操作，也就是新建一个叶子节点，然后把原先数据页中的一部分记录复制到这个新的数据页中，然后再把记录插入进去，把这个叶子节点插入到叶子节点链表中，最后还要在内节点中添加一条`目录项记录`指向这个新创建的页面。很显然，这个过程要对多个页面进行修改，也就意味着会产生多条`redo`日志，我们把这种情况称之为`悲观插入`。假如某个索引对应的`B+`树长这样：
    ...
    ![image_1d4fcomne1lpsp691hg2o416hh2t.png-44.5kB](../images/1694893011fc216e.png)
    
    现在我们要插入一条键值为`10`的记录，很显然需要被插入到`页b`中，但是从图中也可以看出来，此时`页b`已经塞满了记录，没有更多的空闲空间来容纳这条新记录了，所以我们需要进行页面的分裂操作，就像这样：
    
    ![image_1d4fkn8gv1n7enuq23kt1n1uvk3n.png-96.9kB](../images/16948930147d598e.png)
...
*   有的需要保证原子性的操作会生成多条`redo`日志，比如向某个索引对应的`B+`树中进行一次悲观插入就需要生成许多条`redo`日志。
    ...
    ![image_1d4fna6k51fok1mpd1tikkmihg144.png-15kB](../images/16948930162d677f.png)
    
    所以某个需要保证原子性的操作产生的一系列`redo`日志必须要以一个类型为`MLOG_MULTI_REC_END`结尾，就像这样：
    
    ![image_1d4fol2v71fjalphluu1kuf1d8t4h.png-41.4kB](../images/16948930164d64a0.png)
...
*   有的需要保证原子性的操作只生成一条`redo`日志，比如更新`Max Row ID`属性的操作就只会生成一条`redo`日志。
    ...
    ![image_1d4fqlji7md35pdmvvhvibqb4u.png-27.4kB](../images/169489301685dcb4.png)
...
![image_1d4hgjr7t4es1v2mf2b1bt51rf95b.png-27.6kB](../images/169489303b9e5c9f.png)
...
![image_1d4hor6e7nq1mkm1sa41he71rif75.png-57.2kB](../images/169489303bff8e20.png)

真正的`redo`日志都是存储到占用`496`字节大小的`log block body`中，图中的`log block header`和`log block trailer`存储的是一些管理信息。我们来看看这些所谓的`管理信息`都是啥：

![image_1d4hp4u8g13e317mkngoag21clv7i.png-113.9kB](../images/169489303c1fb389.png)
...
![image_1d4i4orkr17vl1m5l3hl1l341pad1j.png-76.5kB](../images/169489303ceeb982.png)
...
![image_1d4jsb3pac9t1pl76drruf1b0574.png-98.4kB](../images/1694893043dc7344.png)
...
![image_1d4ie92r31t57c94e661n861skv2t.png-95.1kB](../images/1692548dcc3fe243.png)
...
![image_1d4jsd7861q6dn9n17gs1cdd1kek7h.png-102.6kB](../images/169489304969c9d7.png)
...
![image_1d4mu4s6f7491l7l1jcc6pc1rbk16.png-49.7kB](../images/1692e62d5c67ac00.png)
...
![image_1d4njgt351je21kitk7u1gbioa46j.png-64.9kB](../images/16931df9929c0145.png)
...
![image_1d4n63euu1t3u1ten1tgicecsar4c.png-51.1kB](../images/1692e62d5ce89bc7.png)
...
*   `log file header`：描述该`redo`日志文件的一些整体属性，看一下它的结构：
    ...
    ![image_1d4nfhoa914vbne4kao7cstr95m.png-65.5kB](../images/1692f2a88a081eb3.png)
...
*   `checkpoint1`：记录关于`checkpoint`的一些属性，看一下它的结构：
    ...
    ![image_1d4njq08pd2a5j9pc01qcn2ps7g.png-60.1kB](../images/16931df99a4cb2c8.png)
...
*   系统第一次启动后初始化`log buffer`时，`buf_free`（就是标记下一条`redo`日志应该写入到`log buffer`的位置的变量）就会指向第一个`block`的偏移量为12字节（`log block header`的大小）的地方，那么`lsn`值也会跟着增加12：
    ...
    ![image_1d4v2r59mr10jdl1vs4fk61huv79.png-50.9kB](../images/169419c0706b589c.png)
    
*   如果某个`mtr`产生的一组`redo`日志占用的存储空间比较小，也就是待插入的block剩余空闲空间能容纳这个`mtr`提交的日志时，`lsn`增长的量就是该`mtr`生成的`redo`日志占用的字节数，就像这样：
  
    ![image_1d4v57vgl1obr1kfcfuunp44bo2t.png-54kB](../images/169419c071a7c8b0.png)
...
*   如果某个`mtr`产生的一组`redo`日志占用的存储空间比较大，也就是待插入的block剩余空闲空间不足以容纳这个`mtr`提交的日志时，`lsn`增长的量就是该`mtr`生成的`redo`日志占用的字节数加上额外占用的`log block header`和`log block trailer`的字节数，就像这样：
    ...
    ![image_1d4v37u011jhc1rpa1fpi5a82ca9.png-99.3kB](../images/169419c071e6cfea.png)
...
![image_1d4q3upvq17n8cargmibugve29.png-84.3kB](../images/16934602a3b4b1be.png)
...
*   系统第一次启动后，向`log buffer`中写入了`mtr_1`、`mtr_2`、`mtr_3`这三个`mtr`产生的`redo`日志，假设这三个`mtr`开始和结束时对应的lsn值分别是：
    ...
    *   `mtr_3`：9948 ～ 10000
    ...
    ![image_1d4v3ubbacgm13171s481trb6kj1m.png-88.5kB](../images/169419c07932ba5d.png)
...
*   随后进行将`log buffer`中的block刷新到`redo`日志文件的操作，假设将`mtr_1`和`mtr_2`的日志刷新到磁盘，那么`flushed_to_disk_lsn`就应该增长`mtr_1`和`mtr_2`写入的日志量，所以`flushed_to_disk_lsn`的值增长到了`9948`，如图：
    ...
    ![image_1d4v40upc1tnt1dpe1l14u2ar4n23.png-100.2kB](../images/169419c079c97169.png)
...
![image_1d4v5sdrj1p1jrhmnfrq4pa073n.png-49.3kB](../images/169419c07a0fd13d.png)
...
![image_1d4uln1ejrt4cerr6h1tc41uok3k.png-227kB](../images/1693d8fc3c18e991.png)
...
*   假设`mtr_1`执行过程中修改了`页a`，那么在`mtr_1`执行结束时，就会将`页a`对应的控制块加入到`flush链表`的头部。并且将`mtr_1`开始时对应的`lsn`，也就是`8716`写入`页a`对应的控制块的`oldest_modification`属性中，把`mtr_1`结束时对应的`lsn`，也就是8404写入`页a`对应的控制块的`newest_modification`属性中。画个图表示一下（为了让图片美观一些，我们把`oldest_modification`缩写成了`o_m`，把`newest_modification`缩写成了`n_m`）：
    ...
    ![image_1d4v63pct1v9o14l3812gnj11de44.png-31.8kB](../images/169419c0b9e35899.png)
...
*   接着假设`mtr_2`执行过程中又修改了`页b`和`页c`两个页面，那么在`mtr_2`执行结束时，就会将`页b`和`页c`对应的控制块都加入到`flush链表`的头部。并且将`mtr_2`开始时对应的`lsn`，也就是8404写入`页b`和`页c`对应的控制块的`oldest_modification`属性中，把`mtr_2`结束时对应的`lsn`，也就是9436写入`页b`和`页c`对应的控制块的`newest_modification`属性中。画个图表示一下：
    ...
    ![image_1d4v64vte14tq1oc911s1v8gnn51.png-59.4kB](../images/169419c0ba64a14c.png)
...
*   接着假设`mtr_3`执行过程中修改了`页b`和`页d`，不过`页b`之前已经被修改过了，所以它对应的控制块已经被插入到了`flush`链表，所以在`mtr_2`执行结束时，只需要将`页d`对应的控制块都加入到`flush链表`的头部即可。所以需要将`mtr_3`开始时对应的`lsn`，也就是9436写入`页c`对应的控制块的`oldest_modification`属性中，把`mtr_3`结束时对应的`lsn`，也就是10000写入`页c`对应的控制块的`newest_modification`属性中。另外，由于`页b`在`mtr_3`执行过程中又发生了一次修改，所以需要更新`页b`对应的控制块中`newest_modification`的值为10000。画个图表示一下：
    ...
    ![image_1d4v68bhl1jb9r8m6vn1b157cn5e.png-110.8kB](../images/169419c0bace2f5a.png)
...
![image_1d4v6h6kp7311ni21mkn1ejkm397i.png-99.3kB](../images/169419c0bb65d251.png)
...
![image_1d4v9cgu21mmcafb1hsp1qtj1di0p.png-79.5kB](../images/169419c0bfca49d0.png)
...
![image_1d4viej35t9nvld8o3141s8pp.png-69.5kB](../images/169419c0e6c648f8.png)
...
![image_1d4vjuf9l17og1papl3e16is1m9f16.png-59.9kB](../images/169419c0e76cca4f.png)
...
*   使用哈希表
    ...
    ![image_1d50lj9da176rojd12ja1lodognc.png-156.4kB](../images/169419c0e8656fbb.png)
...
![image_1d4rt3sm81pbe1tij3pm147op9c30.png-36.9kB](../images/16938e096d57684c.png)
